...
*   **Redirection Link (`.customizer-submit`):** Compiles selection keys, maps them to dynamic languages (Spanish/English), builds a URI-encoded string, and redirects to a dedicated WhatsApp API link (`https://wa.me/15025392085?text=...`) in a new tab.
